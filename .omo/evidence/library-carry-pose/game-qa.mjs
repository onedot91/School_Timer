...
const directory = new URL('./play-', import.meta.url).pathname;
...
finally {await browser.close();receipt.cleanup.push('isolated Chrome closed; root owns3045');await writeFile(directory+'qa.json',JSON.stringify(receipt,null,2));}
