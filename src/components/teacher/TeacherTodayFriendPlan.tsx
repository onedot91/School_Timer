  ...
  return (
    <div className="teacher-today-friend-plan">
      <section className="teacher-today-friend-plan-card">
        <header><div><CalendarDays aria-hidden="true" /><h3>주간 장르</h3></div><button type="button" disabled={isSaving} onClick={() => { void onPlanAction({ action: 'reassign_week', dateKey }); }}><Shuffle aria-hidden="true" />장르 재배정</button></header>
      ...
      <section className="teacher-today-friend-plan-card">
        <header><div><UserRoundCog aria-hidden="true" /><h3>오늘의 파트너</h3></div><button type="button" disabled={isSaving} onClick={() => { void onPlanAction({ action: 'reassign_partners', dateKey }); }}><RefreshCw aria-hidden="true" />파트너 재배정</button></header>
      ...
      <section className="teacher-today-friend-plan-card">
        <header><div><h3>인터뷰 질문</h3></div></header>
