...
import { TODAY_FRIEND_REWARD, canViewTodayFriendMissionPage } from '../../lib/todayFriend';
import {
      ...
      <main className="student-mission-groups">
        <section className="student-mission-group" aria-labelledby="daily-mission-title">
          ...
          <div className="student-mission-grid">
            ...
            {studentMissionVisibility.todayFriend && canViewTodayFriendMissionPage(studentNumber) ? <motion.div {...missionEntrance(auctionMissions.length + 1)}>
              <StudentMissionCard
                title="오늘의 친구"
