export interface StudentCharacter {
  ...
  speech?: string;
  speechTop?: string;
  speechBubbles?: { text: string; left: string; top: string }[];
  walkTransform?: {
    right: string;
    left: string;
  };
...
export const STUDENT_CHARACTERS: StudentCharacter[] = [
  ...
  {
    id: 'student-1-additional',
    name: '1번 추가 자캐',
    creatorName: '1번',
    imageSrc: '/student-characters/character-1-additional.png',
    alt: '1번 학생이 만든 추가 캐릭터',
    speech: '배고파',
    walkTransform: { right: 'none', left: 'scaleX(-1)' },
  },
  {
    id: 'student-4-additional',
    name: '4번 추가 자캐',
    creatorName: '4번',
    imageSrc: '/student-characters/character-4-additional.png',
    alt: '4번 학생이 만든 추가 캐릭터',
    speech: '꾸',
    walkTransform: { right: 'none', left: 'scaleX(-1)' },
  },
  {
    id: 'student-6-additional',
    name: '6번 추가 자캐',
    creatorName: '6번',
    imageSrc: '/student-characters/character-6-additional.png',
    alt: '6번 학생이 만든 추가 캐릭터',
    speech: '냥?',
    walkTransform: { right: 'none', left: 'scaleX(-1)' },
  },
  {
    id: 'student-7-additional',
    name: '7번 추가 자캐',
    creatorName: '7번',
    imageSrc: '/student-characters/character-7-additional.png',
    alt: '7번 학생이 만든 추가 캐릭터',
    speech: '연습중',
    walkTransform: { right: 'scaleX(-1)', left: 'none' },
  },
  {
    id: 'student-12-additional',
    name: '12번 추가 자캐',
    creatorName: '12번',
    imageSrc: '/student-characters/character-12-additional.png',
    alt: '12번 학생이 만든 추가 캐릭터',
    speech: '흥! / 에베베베',
    speechBubbles: [{ text: '흥!', left: '22%', top: '48%' }, { text: '에베베베', left: '78%', top: '32%' }],
    walkTransform: { right: 'none', left: 'none' },
  },
  {
    id: 'student-18-additional',
    name: '18번 추가 자캐',
    creatorName: '18번',
    imageSrc: '/student-characters/character-18-additional.png',
    alt: '18번 학생이 만든 추가 캐릭터',
    speech: '핫바 사줘!',
    walkTransform: { right: 'none', left: 'scaleX(-1)' },
  },
  {
    id: 'student-19-additional',
    name: '19번 추가 자캐',
    creatorName: '19번',
    imageSrc: '/student-characters/character-19-additional.png',
    alt: '19번 학생이 만든 추가 캐릭터',
    speech: '와',
    walkTransform: { right: 'none', left: 'scaleX(-1)' },
  },
  {
  ...
  {
    id: 'student-14-additional',
    name: '14번 추가 자캐',
    creatorName: '14번',
    imageSrc: '/student-characters/character-14-additional.png',
    alt: '14번 학생이 만든 추가 캐릭터',
    speech: 'ㅎㅎㅎ흥응미마',
    walkTransform: { right: 'none', left: 'scaleX(-1)' },
  },
];
