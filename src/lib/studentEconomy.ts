...
export const STUDENT_CHARACTER_DRAW_PRICE = 50;
...
export const STUDENT_CHARACTER_PRIZES = [
  ...
  { id: 'character-57', name: '구미호 고마', imageSrc: '/goma-skins/gumiho-goma.png' },
  { id: 'character-58', name: '굴인형 고마', imageSrc: '/goma-skins/oyster-doll-goma.png' },
  { id: 'character-59', name: '기사 고마', imageSrc: '/goma-skins/knight-goma.png' },
  { id: 'character-60', name: '나는 고마가 아니고마', imageSrc: '/goma-skins/not-goma-goma.png' },
  { id: 'character-61', name: '나무 마법사 고마', imageSrc: '/goma-skins/wood-wizard-goma.png' },
  { id: 'character-62', name: '낙서 고마', imageSrc: '/goma-skins/doodle-goma.png' },
  { id: 'character-63', name: '대두 고마', imageSrc: '/goma-skins/big-head-goma.png' },
  { id: 'character-64', name: '도깨비 고마', imageSrc: '/goma-skins/goblin-goma.png' },
  { id: 'character-65', name: '도적 고마', imageSrc: '/goma-skins/rogue-goma.png' },
  { id: 'character-66', name: '독 마법사 고마', imageSrc: '/goma-skins/poison-wizard-goma.png' },
  { id: 'character-67', name: '라부부 고마', imageSrc: '/goma-skins/labubu-goma.png' },
  { id: 'character-68', name: '로블록스 고마', imageSrc: '/goma-skins/roblox-goma.png' },
  { id: 'character-69', name: '마술사 고마', imageSrc: '/goma-skins/magician-goma.png' },
  { id: 'character-70', name: '마크 고마', imageSrc: '/goma-skins/minecraft-goma.png' },
  { id: 'character-71', name: '모나리자 고마', imageSrc: '/goma-skins/mona-lisa-goma.png' },
  { id: 'character-72', name: '목사 고마', imageSrc: '/goma-skins/pastor-goma.png' },
  { id: 'character-73', name: '몬치치 고마', imageSrc: '/goma-skins/monchhichi-goma.png' },
  { id: 'character-74', name: '변신 로봇 고마', imageSrc: '/goma-skins/transformer-goma.png' },
  { id: 'character-75', name: '별이 빛나는 고마', imageSrc: '/goma-skins/starry-night-goma.png' },
  { id: 'character-76', name: '보석 고마', imageSrc: '/goma-skins/jewel-goma.png' },
  { id: 'character-77', name: '복서 고마', imageSrc: '/goma-skins/boxer-goma.png' },
  ...
  { id: 'character-85', name: '스케이트보드 고마', imageSrc: '/goma-skins/skateboard-goma.png' },
  { id: 'character-86', name: '스프레이 고마', imageSrc: '/goma-skins/spray-goma.png' },
  { id: 'character-87', name: '악마 고마', imageSrc: '/goma-skins/devil-goma.png' },
  { id: 'character-88', name: '알록달록 고마', imageSrc: '/goma-skins/colorful-goma.png' },
  { id: 'character-89', name: '얼룩덜룩 고마', imageSrc: '/goma-skins/spotted-goma.png' },
  { id: 'character-90', name: '얼음 마법사 고마', imageSrc: '/goma-skins/ice-wizard-goma.png' },
  { id: 'character-91', name: '오방색 고마', imageSrc: '/goma-skins/obangsaek-goma.png' },
  { id: 'character-92', name: '유령 고마', imageSrc: '/goma-skins/ghost-goma.png' },
  { id: 'character-93', name: '전기 마법사 고마', imageSrc: '/goma-skins/lightning-wizard-goma.png' },
  { id: 'character-94', name: '전통무늬 고마', imageSrc: '/goma-skins/traditional-pattern-goma.png' },
  { id: 'character-95', name: '절규 고마', imageSrc: '/goma-skins/scream-goma.png' },
  { id: 'character-96', name: '조각 고마', imageSrc: '/goma-skins/sculpture-goma.png' },
  { id: 'character-97', name: '진주 귀걸이를 한 고마', imageSrc: '/goma-skins/pearl-earring-goma.png' },
  { id: 'character-98', name: '탈 고마', imageSrc: '/goma-skins/mask-goma.png' },
  { id: 'character-99', name: '팝아트 고마', imageSrc: '/goma-skins/pop-art-goma.png' },
...
export const STUDENT_HOUSE_DESIGNS = [
  { id: 'student-house-18', name: '고마의 집', creatorStudentNumber: 18, imageSrc: '/student-house-designs/고마의 집(18번).png', price: 100, stagePosition: { width: 43, left: 50, bottom: 20 } },
  { id: 'student-house-10', name: '꼬꼬댁 꼬꼬꼬', creatorStudentNumber: 10, imageSrc: '/student-house-designs/꼬꼬댁 꼬꼬꼬(10번).png', price: 100, stagePosition: { width: 43, left: 50, bottom: 20 } },
  { id: 'student-house-13', name: '삼색 냥이의 집', creatorStudentNumber: 13, imageSrc: '/student-house-designs/삼색 냥이의 집(13번).png', price: 100, stagePosition: { width: 43, left: 50, bottom: 20 } },
  { id: 'student-house-6', name: '소문의 낙원', creatorStudentNumber: 6, imageSrc: '/student-house-designs/소문의 낙원(6번).png', price: 100, stagePosition: { width: 43, left: 50, bottom: 20 } },
  { id: 'student-house-16', name: '지이입', creatorStudentNumber: 16, imageSrc: '/student-house-designs/지이입(16번).png', price: 100, stagePosition: { width: 43, left: 50, bottom: 20 } },
  { id: 'student-house-4', name: '초록 집', creatorStudentNumber: 4, imageSrc: '/student-house-designs/초록 집(4번).png', price: 100, stagePosition: { width: 30, left: 50, bottom: 20 } },
  ...
  { id: 'student-house-12', name: '2층 굴인형 집', creatorStudentNumber: 12, imageSrc: '/student-house-designs/2층 굴인형 집(12번).png', price: 100, stagePosition: { width: 43, left: 50, bottom: 20 } },
