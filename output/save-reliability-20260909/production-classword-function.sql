...
do $$ begin
  if md5(pg_get_functiondef('public.classword_command_v2(integer,text,text,jsonb,integer)'::regprocedure)) <> '5fef6d6878854d3cc1a6c331196bfb48' then
    raise exception 'DEPLOY_FUNCTION_CHANGED_REVIEW_REQUIRED';
  end if;
end $$;
